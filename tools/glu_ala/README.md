...
is never packaged -- see `examples/scaling/glu_ala.py`, which downloads
and reads both ladders directly instead.
...
(`get_structure` upconverts to the library's default dtype after loading,
same as `mstore`).
